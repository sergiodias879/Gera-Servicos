...
- [ ] Schema Drizzle para tabelas (users, clients, orders, schedules)
- [ ] Migrations criadas
- [ ] Relacionamentos entre tabelas
- [ ] Índices para performance

## Phase 11: API & Server
- [ ] TRPC endpoints para CRUD de ordens
- [ ] TRPC endpoints para CRUD de clientes
- [ ] TRPC endpoints para CRUD de agendamentos
